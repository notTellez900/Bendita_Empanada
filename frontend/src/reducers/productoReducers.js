...
export const listaProductoReducer = (state = {productos: []}, action) => {
    switch(action.type){
...
export const productoDetailsReducer = (state = {producto: {opiniones:[]}}, action) => {
    switch(action.type){
...
export const productoTopRatedReducer = (state = { productos: [] }, action) => {
    switch(action.type){
